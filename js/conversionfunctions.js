...
$(document).ready(function () {
    ...
    function clearfields() { /* Function that clears everything and reverts to defaults */
        ...
        /* $('.colorprevbox').css('background-color', '#2f2f2f');
        $('.colorprevboxdata').attr('data-content', " "); */
    }
    ...
    function hex_separator_convertor(a) { // r g b parts of 6-digit hex input is seperated, letters are converted to int and rgb is calculated
        var x = a.substr(0, 1);
        var y = a.substr(1, 1);
    ...
    function rgb_to_hex_separator(x) { // function that clears r value from non-numeric characters and checks min max limits
        var r = x[0];
        var g = x[1];
        var b = x[2];
    ...
    $("#rgb").click(function () {
        ...
        if ((univinput.substr(0, univinput.indexOf(',')) != '') || (univinput.substr(0, univinput.indexOf(' ')) != '')) { // look for comma or space
            ...
            if (((univinput[0] != undefined) && (univinput[0].length > 0)) && ((univinput[1] != undefined) && (univinput[1].length > 0)) && ((univinput[2] != undefined) && (univinput[2].length > 0))) { // r g b not undefined and not empty
                ...
                var computedInverse = convertColor(univinput[0], univinput[1], univinput[2]);
                document.body.style.backgroundColor = rgb;
                $(".input-edit").css({
                    backgroundColor: rgb,
                    color: computedInverse
                });
                $(".mycoloris-anim").css("color", computedInverse);
                $("#openNav").css("color", computedInverse);
    ...
    $("#hex").click(function () {
        ...
        if ((univinput.substr(0, 1) == '#' && univinput.length == 7) || univinput.length == 6) { // 6 digit hex input with # || without #
            ...
            if (!$('#univinput').val().match(hexinputvalidate)) { // check for defined regexp match
                ...
                var r_hex_to_rgb_final = hex_separator_convertor(hex_raw_r); // r part of hex is sent to rgb separator and convertor
                var g_hex_to_rgb_final = hex_separator_convertor(hex_raw_g); // g part of hex is sent to rgb separator and convertor
                var b_hex_to_rgb_final = hex_separator_convertor(hex_raw_b); // b part of hex is sent to rgb separator and convertor
                ...
                var computedInverse = convertColor(r_hex_to_rgb_final, g_hex_to_rgb_final, b_hex_to_rgb_final);
                document.body.style.backgroundColor = hex_to_rgb_final;
                $(".input-edit").css({
                    backgroundColor: hex_to_rgb_final,
                    color: computedInverse
                });
                $(".mycoloris-anim").css("color", computedInverse);
                $("#openNav").css("color", computedInverse);
            ...
            if (!$('#univinput').val().match(hexinputvalidate)) { // check for defined regexp match
                ...
                var r_hex_to_rgb_final = hex_separator_convertor(hex_raw_r); // r part of hex is sent to separator and convertor
                var g_hex_to_rgb_final = hex_separator_convertor(hex_raw_g); // g part of hex is sent to separator and convertor
                var b_hex_to_rgb_final = hex_separator_convertor(hex_raw_b); // b part of hex is sent to separator and convertor
                ...
                var computedInverse = convertColor(r_hex_to_rgb_final, g_hex_to_rgb_final, b_hex_to_rgb_final);
                var computedBg = "rgb(" + r_hex_to_rgb_final + ", " + g_hex_to_rgb_final + ", " + b_hex_to_rgb_final + ")";
        ...
        if ((univinput.substr(0, univinput.indexOf(',')) != '') || (univinput.substr(0, univinput.indexOf(' ')) != '')) { // look for comma or space
            ...
            if (((univinput[0] != undefined) && (univinput[0].length > 0)) &&
                ...
                if ((univinput[0] >= 0 && univinput[0] <= 1) && (univinput[1] >= 0 && univinput[1] <= 1) && (univinput[2] >= 0 && univinput[2] <= 1) && (univinput[3] >= 0 && univinput[3] <= 1)) {
                    ...
                    var computedInverse = convertColor(rgb_from_cmyk[0], rgb_from_cmyk[1], rgb_from_cmyk[2]);
                    document.body.style.backgroundColor = rgb;
                    $(".input-edit").css({
                        backgroundColor: rgb,
                        color: computedInverse
        ...
        if ((univinput.substr(0, univinput.indexOf(',')) != '') || (univinput.substr(0, univinput.indexOf(' ')) != '')) { // look for comma or space
            ...
            if (((univinput[0] != undefined) && (univinput[0].length > 0)) && ((univinput[1] != undefined) && (univinput[1].length > 0)) && ((univinput[2] != undefined) && (univinput[2].length > 0))) { // r g b not undefined and not empty
                if ((univinput[0] > 360) || (univinput[1] > 100) || (univinput[2] > 100)) {
                    ...
                    var rgb_to_hex_final = rgb_to_hex_separator(hsl_to_rgb(univinput[0], univinput[1], univinput[2]));
                    ...
                    var computedInverse = convertColor(r, g, b);
                    document.body.style.backgroundColor = rgb;
                    $(".input-edit").css({
                        backgroundColor: rgb,
                        color: computedInverse
        ...
        if ((univinput.substr(0, univinput.indexOf(',')) != '') || (univinput.substr(0, univinput.indexOf(' ')) != '')) { // look for comma or space
            ...
            if (((univinput[0] != undefined) && (univinput[0].length > 0)) && ((univinput[1] != undefined) && (univinput[1].length > 0)) && ((univinput[2] != undefined) && (univinput[2].length > 0))) { // r g b not undefined and not empty
                ...
                if ((univinput[0] > 360) || (univinput[1] > 100) || (univinput[2] > 100)) {
                    ...
                    var rgb_to_hex_final = rgb_to_hex_separator(hsv_to_rgb(univinput[0], univinput[1], univinput[2]));
                    var rgb = "rgb(" + r + ", " + g + ", " + b + ")"; // form rgb
                    var rgba = "rgba(" + r + ", " + g + ", " + b + ", 1.0" + ")"; // form rgba
                    var rgb_to_cmyk_final = rgb_to_cmyk(r, g, b);
                    var rgb_to_hsl_final = rgb_to_hsl(r + "," + g + "," + b);
     ...
     * This part of js runs when conversion fails.
